...
export default function ChiefSlider(selector, config) {
...
export const onSwipeStart = (e) => {
	e.target.closest('.slider').classList.add('grabbing');
};

export const onSwipeEnd = (e) => {
	document.querySelector('.slider').classList.remove('grabbing');
};
